        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h1 class="mb-3">
              ...
              <small class="text-muted">2.03125rem (32.5px)</small>
            </h1>

            <h2 class="mb-3">
              h2. Bootstrap heading
              <small class="text-muted">1.625rem (26px)</small>
            </h2>

            <h3 class="mb-3">
              h3. Bootstrap heading
              <small class="text-muted">1.42188rem (22.75px)</small>
            </h3>

            <h4 class="mb-3">
              h4. Bootstrap heading
              <small class="text-muted">1.21875rem (19.5px)</small>
            </h4>

            <h5 class="mb-3">
              h5. Bootstrap heading
              <small class="text-muted">1.01563rem (16.25)</small>
            </h5>

            <h6>
              h6. Bootstrap heading
              <small class="text-muted">0.8125rem (13px)</small>
            </h6>
          </div>
        </div>
        <!-- end card -->
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              Remove the default
              <code class="highlighter-rouge">list-style</code> and left margin
            ...
            <div class="row">
              ...
              <div class="col-xl-6">
                <div class="mt-4 mt-lg-0">
                  <blockquote
                    class="blockquote blockquote-reverse font-size-16 mb-0"
                  >
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Integer posuere erat a ante.
