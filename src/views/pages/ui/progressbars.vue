        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              ...
              <code>.progress</code> will automatically resize accordingly.
            </p>
            ...
            <div class="pt-2">
              <div class="custom-progess mb-5">
                ...
                <div class="avatar-sm progress-icon">
                  <span
                    class="avatar-title rounded-circle border border-danger"
                  >
              ...
              <div class="custom-progess mb-5">
                ...
                <div class="avatar-sm progress-icon">
                  <span
                    class="avatar-title rounded-circle border border-primary"
                  >
