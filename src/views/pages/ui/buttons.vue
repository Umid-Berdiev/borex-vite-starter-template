        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              ...
              <code class="highlighter-rouge">.btn-outline-*</code> ones to
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              <button
                type="button"
                class="btn btn-secondary bg-gradient waves-effect waves-light"
              >
                Secondary
              </button>
              <button
                type="button"
                class="btn btn-success bg-gradient waves-effect waves-light"
              >
                Success
              </button>
              <button
              ...
              <button
                type="button"
                class="btn btn-warning bg-gradient waves-effect waves-light"
              >
                Warning
              </button>
              <button
              ...
              <button
                type="button"
                class="btn btn-link bg-gradient waves-effect"
              >
                Link
              </button>
              <button
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="d-flex flex-wrap gap-2">
              ...
              <button
                type="button"
                class="btn btn-outline-light bg-gradient waves-effect"
              >
                Light
              </button>
            </div>
                  ...
                  <div>
                    ...
                    <div>
                      <div class="btn-group btn-group-example" role="group">
                        <button
                          type="button"
                          class="btn btn-outline-secondary w-xs"
                        >
    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              Add <code>.w-xs</code>, <code>.w-sm</code>, <code>.w-md</code> and
    ...
    <div class="row">
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              The <code class="highlighter-rouge">.btn</code> classes are
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              Add
              <code class="highlighter-rouge">data-bs-toggle="button"</code> to
              toggle a button’s
              <code class="highlighter-rouge">active</code> state. If you’re
              ...
              <div class="col-xl-6">
                ...
                >
                  <input
                    ...
                    checked
                  />
                  <label class="btn btn-secondary" for="btnradio1"
                    >Radio 1</label
                  >
