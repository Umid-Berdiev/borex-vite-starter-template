        ...
        <div class="card">
          ...
          <div class="card-body">
            <p class="card-title-desc">
              ...
              the compiled
              <code class="highlighter-rouge">bootstrap.js</code> file—to extend
              our navigational tabs and pills to create tabbable panes of local
            ...
            <div class="tab-content p-3 text-muted">
              ...
              <div class="tab-pane" id="profile-1" role="tabpanel">
                <p class="mb-0">
                  ...
                  letterpress, commodo enim craft beer mlkshk aliquip jean
                  shorts ullamco ad vinyl cillum PBR. Homo nostrud organic,
                  assumenda labore aesthetic magna 8-bit.
                </p>
              </div>
                ...
                >
                  ...
                  >
                    ...
                    <p class="mb-0">
                      ...
                      cred pitchfork. Williamsburg banh mi whatever gluten-free.
                    </p>
                  </div>
                  <div
                    class="tab-pane fade"
            ...
            <div class="tab-content p-3 text-muted">
              ...
              <div class="tab-pane" id="settings1" role="tabpanel">
                <p class="mb-0">
                  ...
                  Lomo wolf viral, mustache readymade keffiyeh craft.
                </p>
              </div>
            </div>
          </div>
              ...
              <div class="col-xl-6">
                <div class="mt-xl-0 mt-4">
                  ...
                  <div class="collapse show" id="collapseExample">
                    <div
                      class="card border shadow-none card-body text-muted mb-0"
                    >
                    ...
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body text-muted">
                          ...
                          wolf moon tempor, sunt aliqua put a bird on it squid
                          single-origin coffee nulla assumenda shoreditch et.
                          Nihil anim keffiyeh helvetica, craft beer raw denim
