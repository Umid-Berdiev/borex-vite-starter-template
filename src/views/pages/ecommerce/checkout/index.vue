                            ...
                            <table class="table table-centered mb-0 table-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-16 text-truncate"><router-link to="/ecommerce/product-detail" class="text-dark">Waterproof Mobile Phone</router-link></h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5 class="font-size-16 text-truncate"><router-link to="/ecommerce/product-detail" class="text-dark">Smartphone Dual Camera</router-link></h5>
                                            <p class="text-muted mb-0">
                                                <i class="bx bxs-star text-warning"></i>
                                                <i class="bx bxs-star text-warning"></i>
                                                <i class="bx bxs-star text-warning"></i>
